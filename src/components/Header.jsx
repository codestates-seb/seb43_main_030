...
function Header() {
  ...
  return (
    <div className="w-1440 mt-40 flex h-80 items-center justify-between border-b border-black-050 px-80 py-16">
      ...
      {isLogin ? (
        <div className="profileContaine flex h-48 w-150 items-center justify-between p-8">
        ...
        <div className="btnContainer flex-center h-42 w-152">
          <SampleButton className="btn-medium-default mr-12 text-14">
            로그인
          </SampleButton>
