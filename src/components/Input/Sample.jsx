...
function SampleInput(props) {
  const { type, value, placeholder, handleChange, isError, isComp, className } =
    props;
    ...
    <div className="input-array">
      <input
        ...
        className={cls(
          ...
          className, // 이 인풋컴포넌트를 사용하는 부모컴포넌트에서 classname을 상속받아서 쓰게 하는 게 재사용성을 높일 수 있을 것같아요 (fail/success 여부에 따라 className을 상속받게 처리)
        )}
